...
Clearing, α_adj, uniform x_init, B1 months, B2 domestic D.7, and B3
horizon N_year+1 are live. Pulse remains (2006 Jan1 cheap dump /
Jan2 empty). Next paste is **B4** in [`GATE0_B_PROMPTS.md`](GATE0_B_PROMPTS.md).
Do not start G1.
