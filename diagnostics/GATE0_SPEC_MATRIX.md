...
| Post-P12 red team | Fig. 4 reproduction bar | n/a | `GATE0_REDTEAM.md` / `GATE0_DATA.md` | R1; not a match |
| Fig. 4-config comparison | 10688435 knobs αI=3.5, ζ=1, N_for=6 on USDA/EU-27 host | n/a | `fig4_config.py` / `score_agrimate_fig4_config.py` | R2 `fig4_config.md`; labelled; `wheat_params()` unchanged |
