...
- **2007/08** obs×1.82  `full`×2.09  `shocks`×1.15  `demand`×0.92  `tau`×1.61
- **2010/11** obs×1.16  `full`×1.31  `shocks`×1.79  `demand`×1.30  `tau`×1.28

## Attribution (which isolated leg carries the hike)
- 2007/08: shocks×1.15  demand×0.92  tau×1.61 (full×2.09) — restriction-led
- 2010/11: shocks×1.79  demand×1.30  tau×1.28 (full×1.31) — production-led
- **tau column, unpinned baseline**: 2007/08 ×1.82 (vs ×1.61 above), 2010/11 ×1.28 (vs ×1.28) — restriction-led / production-led
...
- 2006: Dec 242.4 MMT (STU 0.49); MY-end 126.3 MMT (STU 0.26) vs PSD 134.8 MMT (STU 0.27)
- 2007: Dec 276.7 MMT (STU 0.56); MY-end 139.4 MMT (STU 0.28) vs PSD 129.2 MMT (STU 0.26)
- 2008: Dec 339.8 MMT (STU 0.67); MY-end 166.6 MMT (STU 0.33) vs PSD 170.3 MMT (STU 0.33)
- 2009: Dec 351.8 MMT (STU 0.67); MY-end 212.2 MMT (STU 0.40) vs PSD 203.8 MMT (STU 0.39)
- 2010: Dec 321.3 MMT (STU 0.60); MY-end 207.4 MMT (STU 0.39) vs PSD 199.6 MMT (STU 0.38)
- 2011: Dec 349.2 MMT (STU 0.62); MY-end 203.2 MMT (STU 0.36) vs PSD 200.1 MMT (STU 0.35)
...
- Mean model/PSD MY-end excluding China: ×1.08 (including China ×1.02)
- China stock *levels* are estimated (state reserves, not a Gate 0 fail). This series is the traded-market remainder.
- 2006: ex-China 96.7 vs PSD 96.2 MMT (STU 0.25 vs 0.25; China 29% of PSD world)
- 2007: ex-China 105.8 vs PSD 89.9 MMT (STU 0.27 vs 0.23; China 30% of PSD world)
- 2008: ex-China 125.5 vs PSD 123.9 MMT (STU 0.31 vs 0.31; China 27% of PSD world)
- 2009: ex-China 162.0 vs PSD 149.6 MMT (STU 0.39 vs 0.36; China 27% of PSD world)
- 2010: ex-China 158.9 vs PSD 140.8 MMT (STU 0.38 vs 0.34; China 29% of PSD world)
- 2011: ex-China 154.5 vs PSD 144.3 MMT (STU 0.35 vs 0.33; China 28% of PSD world)
...
- 2006: model 618.4 vs PSD 619.1 MMT (×1.00; Δ — / — pp)
- 2007: model 578.3 vs PSD 614.4 MMT (×0.94; Δ -6.2 / -0.7 pp)
- 2008: model 569.9 vs PSD 636.8 MMT (×0.89; Δ -1.3 / +3.5 pp)
- 2009: model 607.9 vs PSD 650.9 MMT (×0.93; Δ +5.9 / +2.2 pp)
- 2010: model 623.2 vs PSD 653.4 MMT (×0.95; Δ +2.4 / +0.4 pp)
- 2011: model 573.3 vs PSD 690.8 MMT (×0.83; Δ -7.8 / +5.8 pp)
- 2011 named-node snapshot (psd_cons>10 MMT):
  - RestOfWorld: model 159.0 vs PSD 192.2 MMT (×0.83)
  - EU: model 110.7 vs PSD 126.7 MMT (×0.87)
  - China: model 97.7 vs PSD 123.5 MMT (×0.79)
  - India: model 68.7 vs PSD 81.4 MMT (×0.84)
  - Russia: model 34.1 vs PSD 38.0 MMT (×0.90)
  - USA: model 27.7 vs PSD 32.0 MMT (×0.87)
...
- Russia assert_AugDec2010 2010-08→2010-12: offer ×0.11, ship ×0.73 (cut; τ̄=0.95)
- Ukraine quota_2010_11 2010-10→2011-06: offer ×1.17, ship ×1.45 (up; τ̄=0.70)
- Russia calendar-year exports vs PSD:
  - 2007: full 9.1 vs no-AMIS 10.9 vs PSD 12.2 MMT (model/PSD ×0.75)
  - 2008: full 11.4 vs no-AMIS 11.0 vs PSD 18.4 MMT (model/PSD ×0.62)
  - 2010: full 9.8 vs no-AMIS 10.4 vs PSD 4.0 MMT (model/PSD ×2.47)
  - 2011: full 3.9 vs no-AMIS 6.1 vs PSD 21.6 MMT (model/PSD ×0.18)

## Country MY-end stocks vs PSD (local marketing year, not groupings)
- Median model/PSD stock (psd>1 MMT): ×0.46 (mean ×0.72)
- Median model/PSD consumption: ×0.92
- Δstock sign agreement: 39/85
- 2011 snapshot (psd>2 MMT):
  - China (m=6): model 88.1 vs PSD 55.8 MMT (×1.58)
  - RestOfWorld (m=5): model 5.9 vs PSD 39.5 MMT (×0.15)
  - USA (m=5): model 5.1 vs PSD 20.2 MMT (×0.25)
  - India (m=3): model 34.9 vs PSD 19.9 MMT (×1.75)
  - EU (m=6): model 19.4 vs PSD 15.6 MMT (×1.25)
  - Russia (m=6): model 9.2 vs PSD 10.9 MMT (×0.85)
  - Egypt (m=5): model 3.6 vs PSD 7.1 MMT (×0.51)
  - Australia (m=9): model 1.5 vs PSD 7.1 MMT (×0.21)
  - Kazakhstan (m=6): model 1.2 vs PSD 6.2 MMT (×0.19)
  - Canada (m=7): model 1.0 vs PSD 5.9 MMT (×0.16)
  - Ukraine (m=6): model 2.7 vs PSD 5.4 MMT (×0.50)
