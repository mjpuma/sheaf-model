...
- **2007/08** obs×1.82  `full`×2.28  `shocks`×1.20  `demand`×0.99  `tau`×1.71
- **2010/11** obs×1.16  `full`×1.45  `shocks`×1.87  `demand`×1.36  `tau`×1.38

## Attribution (which isolated leg carries the hike)
- 2007/08: shocks×1.20  demand×0.99  tau×1.71 (full×2.28) — restriction-led
- 2010/11: shocks×1.87  demand×1.36  tau×1.38 (full×1.45) — production-led
- **tau column, unpinned baseline**: 2007/08 ×2.00 (vs ×1.71 above), 2010/11 ×1.37 (vs ×1.38) — restriction-led / production-led
...
- 2006: Dec 241.1 MMT (STU 0.49); MY-end 126.0 MMT (STU 0.26) vs PSD 134.8 MMT (STU 0.27)
- 2007: Dec 279.2 MMT (STU 0.56); MY-end 140.0 MMT (STU 0.28) vs PSD 129.2 MMT (STU 0.26)
- 2008: Dec 341.9 MMT (STU 0.67); MY-end 169.5 MMT (STU 0.33) vs PSD 170.3 MMT (STU 0.33)
- 2009: Dec 350.9 MMT (STU 0.67); MY-end 212.9 MMT (STU 0.40) vs PSD 203.8 MMT (STU 0.39)
- 2010: Dec 320.2 MMT (STU 0.60); MY-end 204.9 MMT (STU 0.39) vs PSD 199.6 MMT (STU 0.38)
- 2011: Dec 349.8 MMT (STU 0.62); MY-end 204.4 MMT (STU 0.36) vs PSD 200.1 MMT (STU 0.35)
...
- 2006: ex-China 96.6 vs PSD 96.2 MMT (STU 0.25 vs 0.25; China 29% of PSD world)
- 2007: ex-China 106.2 vs PSD 89.9 MMT (STU 0.27 vs 0.23; China 30% of PSD world)
- 2008: ex-China 127.4 vs PSD 123.9 MMT (STU 0.32 vs 0.31; China 27% of PSD world)
- 2009: ex-China 162.4 vs PSD 149.6 MMT (STU 0.39 vs 0.36; China 27% of PSD world)
- 2010: ex-China 156.8 vs PSD 140.8 MMT (STU 0.37 vs 0.34; China 29% of PSD world)
- 2011: ex-China 155.4 vs PSD 144.3 MMT (STU 0.35 vs 0.33; China 28% of PSD world)
...
- 2006: model 619.9 vs PSD 619.1 MMT (×1.00; Δ — / — pp)
- 2007: model 574.1 vs PSD 614.4 MMT (×0.93; Δ -7.1 / -0.7 pp)
- 2008: model 569.1 vs PSD 636.8 MMT (×0.89; Δ -0.8 / +3.5 pp)
- 2009: model 610.8 vs PSD 650.9 MMT (×0.94; Δ +6.5 / +2.2 pp)
- 2010: model 624.2 vs PSD 653.4 MMT (×0.96; Δ +2.1 / +0.4 pp)
- 2011: model 570.9 vs PSD 690.8 MMT (×0.83; Δ -8.3 / +5.8 pp)
- 2011 named-node snapshot (psd_cons>10 MMT):
  - RestOfWorld: model 158.3 vs PSD 192.2 MMT (×0.82)
  - EU: model 110.3 vs PSD 126.7 MMT (×0.87)
...
- Russia assert_AugDec2010 2010-08→2010-12: offer ×0.11, ship ×0.72 (cut; τ̄=0.95)
- Ukraine quota_2010_11 2010-10→2011-06: offer ×1.15, ship ×1.43 (up; τ̄=0.70)
- Russia calendar-year exports vs PSD:
  - 2007: full 9.1 vs no-AMIS 11.0 vs PSD 12.2 MMT (model/PSD ×0.74)
  - 2008: full 11.5 vs no-AMIS 11.1 vs PSD 18.4 MMT (model/PSD ×0.63)
  - 2010: full 10.0 vs no-AMIS 10.4 vs PSD 4.0 MMT (model/PSD ×2.50)
...
- Δstock sign agreement: 38/85
- 2011 snapshot (psd>2 MMT):
  - China (m=6): model 88.4 vs PSD 55.8 MMT (×1.58)
  - RestOfWorld (m=5): model 6.2 vs PSD 39.5 MMT (×0.16)
  - USA (m=5): model 5.1 vs PSD 20.2 MMT (×0.25)
  - India (m=3): model 35.1 vs PSD 19.9 MMT (×1.76)
  - EU (m=6): model 19.6 vs PSD 15.6 MMT (×1.26)
  - Russia (m=6): model 9.3 vs PSD 10.9 MMT (×0.85)
  - Egypt (m=5): model 3.6 vs PSD 7.1 MMT (×0.51)
  - Australia (m=9): model 1.5 vs PSD 7.1 MMT (×0.22)
