...
sheaf.annual.core
=================
Annual SPE prototype — parked from when the market itself was annual
(TWIST). Crisis hindcasts and the crisis game do **not** use this module.

Import: ``from sheaf.annual import SheafModel, build_countries``.
Demo: ``python scripts/annual/demo.py``.
Equations: ``sheaf/annual/README.md``.

Crisis host: ``sheaf/dynamic_crop.py`` (24 steps/year).
Gate 1: ``sheaf/dynamic_coupled.py``.
Crisis game: ``sheaf/dynamic_policy.py``.
